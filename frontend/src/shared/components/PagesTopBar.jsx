...
export const pagesTopBarEyebrowClass =
    'text-[12px] md:text-[13px] font-bold uppercase tracking-[0.1em] text-[#801829] dark:text-[#c24a58] mb-2';
...
const PagesTopBar = ({
    ...
    const actionsBlock = hasActions ? (
        <div className={`order-3 z-10 flex shrink-0 flex-wrap items-center gap-3 md:order-none md:self-center ${pagesTopBarUiSansClass}`}>
            {children}
        </div>
    ) : null;
